...
(
    ...
    `params`     varchar(2000) NOT NULL DEFAULT '' COMMENT '任务数据',
    `created_at` timestamp     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` timestamp     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
    KEY          `idx_state` (`state`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='小r任务表';
...
(
    ...
    PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
    KEY             `idx_state` (`state`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='资产转移';
...
(
    ...
    PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
    KEY                `idx_state` (`state`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='交易';
...
(
    ...
    PRIMARY KEY (`id`) /*T![clustered_index] CLUSTERED */,
    KEY            `idx_state` (`state`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='组LP';